...
occam %>% 
  ...
  ggplot2::ggplot(aes(total, ell, color = as.factor(sample_size), shape = distribution ))+
...
occam %>% 
  ...
  ggplot2::ggplot(aes(bias, ell, color = as.factor(sample_size), shape = distribution ))+
  ggplot2::geom_jitter(height = 0, width = 0.4)+
  ggplot2::scale_color_manual(values = hcl.colors(4, "Plasma")) +
  ggplot2::facet_wrap(~evenness)+
...
occam %>% 
  dply::filter(variability %in% c(TRUE, FALSE)) %>% 
  ggplot2::ggplot(aes(variability, ell, color = as.factor(sample_size), shape = distribution ))+
  ggplot2::geom_jitter(height = 0, width = 0.4)+
  ggplot2::scale_color_manual(values = hcl.colors(4, "Plasma")) +
  ggplot2::facet_wrap(~evenness)+
