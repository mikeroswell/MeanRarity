...
metrics for biodiversity quantification (Cite Chao, Jost, Roswell, others).
However, even with this unified family of measures, there is a wide array of
metrics that may be appropriate for a given case, opening the questions of how
to choose among them or interpret differences between them. Here, we introduce
the R package **MeanRarity**, which enables estimating and visualizing Hill
diversity (aka "Hill numbers") in terms of the average species "rarity." Rarity
is defined as the reciprocal of relative abundance.
