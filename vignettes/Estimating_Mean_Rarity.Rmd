...
in the MS. Rather than showing all 24, we'll look at 6: The most and least even
ones, and one of the intermediate ones as well.
...
2012). These functions are not exported by this package, and the scripts
and data we used for the supplementary materials are available at [github link]
