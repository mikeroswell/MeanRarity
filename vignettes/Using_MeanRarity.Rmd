...
When $\ell =1$ ($q=0$) these equations are defined by their limit.
...
in which all species are equally abundant [@Jost2006]. <!-- sharpen this, maybe be more explicit about asking what does $\ell$ mean--> In this perspective, the
...
<!-- make sure to add $\ell$ to these plots!-->
