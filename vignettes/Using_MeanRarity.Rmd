...
```{r Balance_plot_setup, warning=FALSE, message=FALSE}
...
```{r Balance_plot_print, out.width='33%', out.height='33%', fig.show="hold"}
rich_bal
shan_bal
simp_bal
...
```{r sidenote on when naive beats asymptotic}
