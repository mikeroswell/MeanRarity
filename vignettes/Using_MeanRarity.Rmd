...
plot_data %>%
  ...
  ggplot2::theme_classic() +
  ggplot2::xlim(c(-1,1)) +
  ggplot2::scale_color_manual(values = hcl.colors(5, palette = "Emrld")[2:4]) +
...
plot_data %>%
  ...
  ggplot2::theme_classic() +
  ggplot2::xlim(c(-1,1)) +
  ggplot2::scale_color_manual(values = hcl.colors(5, palette = "Red-Blue")[2:4]) +
  ggplot2::facet_wrap(~sample_size
                      , labeller = "label_both") +
  #function(x){sapply(x, function(y){paste(y, " individuals")})}) +
  ggplot2::labs(x = "scaling exponent \U2113"
...
plot_data %>%
  ...
  ggplot2::scale_color_manual(values = 
                                hcl.colors(5, palette = "SunsetDark")[2:4]) +
  ggplot2::facet_wrap(~sample_size
                      , labeller = "label_both") +  
  #function(x){sapply(x, function(y){paste(y, " individuals")})}) +
  ggplot2::labs(x = "scaling exponent \U2113"
