...
```
# ABSTRACT 
<!-- 350 words max, now like 500 -->

<!--context for and purpose of the work-->
...
comparison or interpretation of disparate metrics, can fuel false beliefs about
...
rarity opens avenues to investigate the numerical and statistical properties of
...
known diversity. To illustrate the use of **MeanRarity**, we simulate species
abundance distributions that vary in shape but not richness, and estimate the
diversity of these assemblages based on random samples from these distributions.
We investigate how the bias and variability of Hill diversity estimates (i.e.,
the diversity of the sample, and the estimated true diversity of the whole
species abundance distribution) depend on the scaling parameter in the Hill
equation, features of the species abundance distribution such as evenness, and
sampling intensity.
...
scaling parameter values between -1 and 1) for small, incomplete samples.
