...
Generating many SADs with different diversities and distributional assumptions
provides scope to test proposed confidence intervals (Béguinot, 2018).
...
In the supplementary materials for Roswell et al. 2020, we demonstrate that the
CI for diversity estimates based on the approach articulated in (CITE Chao and
Jost 2012) tend to be anticonservative. The code and data for this are not
exported by this package; the scripts to generate all relevatn data and figures
