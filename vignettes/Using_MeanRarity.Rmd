...
$\ell < \sim 0.75 $. Less well-understood is how different features of the
...
plot_data %>%
  ...
  ggplot2::scale_y_continuous(limits = c(-0, 1.3), expand = c(0,0)) +
...
plot_data %>%
  ggplot2::ggplot(ggplot2::aes(x = ell
                               ...
                               , color = evenness
                               , shape = distribution)) +
  ggplot2::geom_line(ggplot2::aes(color = evenness
  ...
  #function(x){sapply(x, function(y){paste(y, " individuals")})}) +
  ggplot2::labs(x = "scaling exponent \U2113"
                , y = "scaled variability in sample diversity (sdlog)") +
...
plot_data %>%
  ...
  #function(x){sapply(x, function(y){paste(y, " individuals")})}) +
  ggplot2::labs(x = "scaling exponent \U2113"
                , y = "scaled variability in asymptotic diversity 
                estimate (sdlog)") +
  ggplot2::scale_y_continuous(limits = c(0, NA),
                              expand = ggplot2::expansion(mult = c(0, 0.1)))
