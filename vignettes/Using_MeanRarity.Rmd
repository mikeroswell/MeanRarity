...
[e.g., @Chao2014b; @Haegeman2013; @Tuomisto2010a]. Another interpretation
...
diversity, and Hill-Simpson diversity in purple, red, and green respectively). <!-- too much of a mouthful?-->
By default, each individual is plotted as a "block", and species with the same
rarity are stacked vertically.
...
"asymptotic estimator" [@Chao2015]. All three approaches have merit for
comparing communities and ecosystems [@Gooriah2021] <!-- may want a stronger
reference here-->. While the degree to which sample diversity and asymptotic
estimates each differ from the true diversity (bias) has received substantial
study, the sampling variation in each type of Hill diversity estimate is less
...
purrr::map(c("lnorm", "gamma", "invgamma"), function(dist){
   myp <- err_plot_data %>% 
    ...
    ratioScales::scale_y_ratio(slashStar = FALSE) + 
